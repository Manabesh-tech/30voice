...
import { X, Mic, Upload, Play, Pause, Square } from 'lucide-react'
          ...
          <div className="space-y-4">
            <div className="text-center">
                ...
                {!recordedBlob ? (
                  <button
                    ...
                    className={`w-20 h-20 rounded-full flex items-center justify-center transition-colors ${
                      recording ? 'bg-red-500 hover:bg-red-600' : 'bg-purple-600 hover:bg-purple-700'
                    }`}
                  >
                    {recording ? (
              ...
              <p className="text-sm text-gray-600">
                {recording ? 'Recording... Click to stop' : recordedBlob ? 'Recording complete' : 'Click to start recording'}
              </p>
            </div>
          </div>
        )}
